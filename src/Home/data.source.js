  ...
  BannerAnim: {
    children: [
      ...
      },
      {
        ...
        BannerElement: { className: 'banner-user-elem' },
        textWrapper: { className: 'banner1-text-wrapper' },
        bg: { className: 'bg bg1 kumid1512ke-editor_css' },
        title: {
          className: 'banner1-title kumifvzx85-editor_css',
          children:
            'https://zos.alipayobjects.com/rmsportal/HqnZZjBjWRbjyMr.png',
        },
        content: {
          className: 'banner1-content kumig56jtz9-editor_css',
          children: '一个高效的页面动画解决方案',
        },
        button: {
          className: 'banner1-button kumige7yh6l-editor_css',
          children: 'Learn More',
        },
      },
      {
        name: 'elem~kumi69smgb9',
        BannerElement: { className: 'banner-user-elem' },
        textWrapper: { className: 'banner1-text-wrapper' },
        bg: { className: 'bg bg1' },
        title: {
      ...
      {
        name: 'elem~kumi6bfjhx',
        BannerElement: { className: 'banner-user-elem kumibzdusqc-editor_css' },
        textWrapper: { className: 'banner1-text-wrapper' },
        bg: { className: 'bg bg1' },
        title: {
          className: 'banner1-title',
  ...
  content: {
    ...
    children: (
      <span>
        <span>
          <p>
            产品描述产品描述产品描述产品描述产品描述产品描述产品描产品描述述产品描述产品描述产品描述产品描述产品描述产品描述产品描述产品描述产品描述产品描
          </p>
          <p>
            <br />
          </p>
          <p>
            述产品描述产品描述产品描述产品描述产品描述产品描述产品描述产品描述产品描述产品描述产品描述产品
          </p>
          <p>
            <br />
          </p>
  ...
  content: {
    ...
    children: (
      <span>
        <span>
          <p>
            产品描述产品描述产品描述产品描述产品描述产品描述产品描述产品描述产品描述产品描述产品描述产品描述产品描述
          </p>
          <p>
            <br />
          </p>
          <p>
            产品描述产品描述产品描述产品描述产品描述产品描述产品描述产品描述<br />
          </p>
          <p>
            产品描述产品描述<br />
          </p>
...
export const Teams20DataSource = {
  ...
  page: { className: 'home-page teams2 ksx4zl8oo9-editor_css' },
  OverPack: {
    playScale: 0.3,
    className: '',
    appear: false,
...
export const Contact00DataSource = {
  wrapper: {
    className: 'home-page-wrapper content10-wrapper ksvx1bnff7-editor_css',
  },
  Content: {
